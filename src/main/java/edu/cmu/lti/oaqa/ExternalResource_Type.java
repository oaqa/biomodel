 ...
 * @generated */
public class ExternalResource_Type extends OAQATop_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.oaqa.ExternalResource");
  ...
  public String getConcept(int addr) {
      ...
      jcas.throwFeatMissing("concept", "edu.cmu.lti.oaqa.ExternalResource");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "edu.cmu.lti.oaqa.ExternalResource");
  ...
  public int getSynonyms(int addr) {
      ...
      jcas.throwFeatMissing("synonyms", "edu.cmu.lti.oaqa.ExternalResource");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "edu.cmu.lti.oaqa.ExternalResource");
